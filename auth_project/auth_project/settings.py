...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('MYSQL_HOST'),   # Or the IP address where MySQL is hosted
        'PORT': os.getenv('MYSQL_PORT'),        # MySQL port (default is 3306)
    }
}
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            ...
            "hosts": [('redis', 6379)],  # Replaced 'localhost' with redis service name.
